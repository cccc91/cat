...
public class GlobalMonitoringConfiguration extends AbstractConfiguration {
    ...
    public void setPeriodicSpeedTestPollingPeriod(String aInPollingPeriod) throws NumberFormatException {
        if ((aInPollingPeriod != null) && !Integer.valueOf(aInPollingPeriod).equals(periodicSpeedTestPollingPeriod)) {
            if (Integer.valueOf(aInPollingPeriod) > Constants.MAX_POLLING_PERIOD || Integer.valueOf(aInPollingPeriod) < Constants.MIN_POLLING_PERIOD)
                throw new NumberFormatException();
    ...
    public Integer getPeriodicSpeedTestPollingPeriod() {
