...
public class MonitoringJobView {
    ...
    /**
     * Disables active server slider
     */
    public void disableActiveServerSlider() {
        activeServerSlider.setDisable(true);
    }
    ...
    public void setDetailsScrollPolicy() {
        ...
        // Add listener to detail scroll pane so that auto scroll is audibleEnabled or disabled depending on user action
