...
public class ConfiguredInterface {
     ...
     */
    public ConfiguredInterface(NetworkInterfaceConfiguration aInNetworkInterfaceConfiguration) {
     ...
     */
    public ConfiguredInterface(NetworkInterface aInNetworkInterface, int aInPriority) {
