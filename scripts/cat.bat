...
chcp 1252 > NUL
java -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=5005 -Xms512m -Xmx1400m -cp "%CAT_CP%" -Dlog4j.skipJansi=true -Dcom.sun.management.jmxremote=true cclerc.cat.Cat %*
